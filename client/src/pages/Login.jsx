        ...
        <div className="min-h-[calc(100vh-80px)] flex justify-center items-center bg-gray-50 p-6">
            ...
            >
                <div className="text-center mb-10">
                    ...
                    <p className="text-gray-500">Sign in to access your digital library</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        <Link to="#" className="text-xs text-indigo-600 hover:text-indigo-800 float-right font-semibold relative top-1">Forgot Password?</Link>
                ...
                <div className="mt-8 pt-8 border-t border-gray-100 text-center text-gray-600">
                    Don't have an account yet? <Link to="/register" className="text-indigo-600 hover:text-indigo-800 font-bold ml-1">Create Account</Link>
                </div>
            </motion.div>
        </div>
    );
